...
namespace social_octomap
{
  ...
  void ColorOcTreeDrawer::setOcTree(const AbstractOcTree &tree_pnt,
                                    const social_octomap::pose6d &origin_,
                                    int map_id_)
  {
    ...
    this->initial_origin = social_octomap::pose6d(social_octomap::point3d(0, 0, 0), origin_.rot());
    ...
    bool uses_origin = ((origin_.rot().x() != 0.) && (origin_.rot().y() != 0.) && (origin_.rot().z() != 0.) && (origin_.rot().u() != 1.));
